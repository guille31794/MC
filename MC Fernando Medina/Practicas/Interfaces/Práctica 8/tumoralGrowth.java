...
class panelIma extends JPanel{
	static BufferedImage image;

	public panelIma(int dim){
            ...
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if(btnStart.getText().equals("Iniciar")){
                    ...
                    btnStart.setText("Reiniciar");
                   	tumoralGrowth.ngen= Integer.parseInt(boxGen.getText());
                   	tumoralGrowth.max= Integer.parseInt(boxGen.getText());
                   	parallelTumoralGrowth.cells= Integer.parseInt(boxCell.getText());
                    hiloSim = new Thread(()->{tumoralGrowth.runSimulation(Integer.parseInt(boxDim.getText()),
        ...
        btnGrafic.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if(btnGrafic.getText().equals("Grafica") && btnStart.getText().equals("Reiniciar")){
                	curvasPoblacion objeto = new curvasPoblacion(tumoralGrowth.vivas, Integer.parseInt(boxDim.getText()));
                }

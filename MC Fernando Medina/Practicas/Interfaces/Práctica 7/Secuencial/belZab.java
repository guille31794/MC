...
public class belZab extends JFrame implements ca2DSim, Runnable,ActionListener{
	...
	public static void runSimulation(int d, int ngen, float alf, float bet, float gamm){
		...
		//try{
				for(int i=0;i<nHilos;++i){
					bz = new belZab(i*belZab.dim/nHilos,(i+1)*belZab.dim/nHilos);
					ex.execute(bz);
				}
				ex.shutdown();
	...
	public belZab(){
		...
		setTitle("BelZab - Fernando Medina Delgado");
